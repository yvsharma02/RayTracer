    ...
    public class DefaultShapeShader : ShapeShader
    {
        ...
        public override RTColor CalculateBounceColor(Shape shape, ColoredRay[][] hittingRays, Vector3D pointOfContact, Vector3D bouncedRayDirection)
        {
            ...
            if (MainTexture != null)
            {
                ...
                r = (r + MainTexture[shape.POCToTexturePixelIndex(pointOfContact, TextureDimensions)].R) / 2f;
                g = (g + MainTexture[shape.POCToTexturePixelIndex(pointOfContact, TextureDimensions)].G) / 2f;
                r = (b + MainTexture[shape.POCToTexturePixelIndex(pointOfContact, TextureDimensions)].B) / 2f;
            }
